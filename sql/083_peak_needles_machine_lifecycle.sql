-- Peak Needles é revenda/white-label, não fabricante de máquinas.
-- Remove as máquinas (PEN/ROTARY/COIL) do catálogo técnico de máquinas,
-- mantendo acessórios, baterias, cartuchos e fontes da marca.
...
update catalog.product_model
 ...
 where manufacturer_id=(select id from catalog.manufacturer where slug='peak-needles')
